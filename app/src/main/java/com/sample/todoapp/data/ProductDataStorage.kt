...
import com.sample.todoapp.home.Product
...
class ProductDataStorage {
    ...
    suspend fun addProductsToList(): List<Product> = withContext(Dispatchers.IO) {
        ...
        val p2 =
            Product(2, "Galeriden 2018 model a180", "Besiktas, Istanbul", 2546000, "a180", false)
        ...
        val p5 = Product(
            5,
            "İlk sahibinden değişensiz Mercedes",
            "Alanya, Antalya",
            1585000,
            "suv",
            false
        ...
        val p6 =
            Product(6, "Cam tavan 8 ileri vitesli E250", "Çankaya, Ankara", 2750000, "e250", true)
        val p7 = Product(
            7,
            "Yeni Muayeneli 2020 model C180",
            "Sarıyer, Istanbul",
            1677000,
            "c180_view",
            false
